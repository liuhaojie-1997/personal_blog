# Generated by Django 3.0.4 on 2020-04-18 02:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(blank=True, default=None, max_length=11, unique=True, validators=[django.core.validators.RegexValidator('^1[3-9]\\d{9}$', '手机号码不正确')], verbose_name='手机号码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app01.User', verbose_name='用户')),
            ],
            options={
                'verbose_name': '评论',
