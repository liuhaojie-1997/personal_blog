# Generated by Django 3.0.4 on 2020-07-07 03:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(blank=True, default=None, max_length=11, null=True, unique=True, validators=[django.core.validators.RegexValidator('^1[3-9]\\d{9}$', '手机号码不正确')], verbose_name='手机号码')),
                ('email', models.EmailField(max_length=254, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9\\u4e00-\\u9fa5]+@[a-zA-Z0-9_-]+(\\.[a-zA-Z0-9_-]+)+$', '邮箱格式不正确')])),
                ('gender', models.CharField(choices=[('male', '男'), ('female', '女'), ('unknown', '保密')], default='unknown', max_length=20, verbose_name='性别')),
                ('hobby', models.TextField(blank=True, max_length=32, null=True)),
